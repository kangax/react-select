f/* disable some rules until we refactor more completely; fixing them now would
...
var Select = createReactClass({
   ...
   */
	...
	componentWillReceiveProps: function componentWillReceiveProps(newProps) {
		...
		if (newProps.value !== this.state.value || newProps.placeholder !== this.props.placeholder || this.optionsChanged) {
